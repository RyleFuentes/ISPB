<div class="container-fluid">
    <form wire:submit='addNewProduct'>
        <div class="row">
            ...
            @if ($product_image)
                    <div
                        class="col-md-4 bg-secondary rounded d-flex flex-column justify-content-center align-items-center mt-3">
                        <img class="img-fluid" src="{{ $product_image->temporaryUrl() }}" alt="preview">
                    </div>
            @else
                   
                    <div
                        class="col-md-4 bg-secondary bg-opacity-50 rounded d-flex flex-column justify-content-center align-items-center mt-3">
                         <input wire:model='product_image' type="file" accept="image/png, image/jpg" id="image" class="form-control">
                    </div>
                    @error('product_image')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <div class="form-group my-3 mx-3 text-start">
            <button type="submit" class="btn btn-primary rounded-3 px-5">
                    <i class="fa fa-plus-circle me-2 text-light"></i>Add Product
            </button>
            <a class="btn btn-outline-dark rounded-3 px-5" href="/products">
                Discard
            </a>
        </div>
    </form>
