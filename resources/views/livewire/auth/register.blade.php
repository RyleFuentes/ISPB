<div class="">
    <div class="d-flex shadow-lg" style="justify-content: space-between; flex-direction:row-reverse">
        <div class="container rounded p-5 border border-dark border-start-0 text-light" style="backdrop-filter: blur(7px); height: 00vh;">
        ...
        <div class="container rounded p-5 border border-dark border-end-0 d-flex flex-column justify-content-center align-content-center" style="backdrop-filter: blur(7px); height: 50vh;">
            ...
            <form wire:submit='register'class="form">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="flex-column">
                        <div class="form-floating mt-3 flex-fill ps-1">
