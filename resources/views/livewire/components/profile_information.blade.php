            ...
            <form wire:submit='update_profile'>
                ...
                <div>
                    <div class="form-group mt-3 mb-0">
                        ...
                        <input wire:model='update_name' type="text" class="form-control bg-primary bg-opacity-50 text-light">
                    </div>
                    @error('update_name')
            ...
            <form wire:submit='update_profile'>
                <div class="px-3">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input wire:model='update_address' type="text" class="form-control  bg-primary bg-opacity-50 text-light">
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="number" class="form-control bg-primary bg-opacity-50 text-light" wire:model='update_number'>
                    </div>
                    @error('update_number')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="date" class="form-control  bg-primary bg-opacity-50 text-light" wire:model='update_dateOfBirth'>
                    </div>
